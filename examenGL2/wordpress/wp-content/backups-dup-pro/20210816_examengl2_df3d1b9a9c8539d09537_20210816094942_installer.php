...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210816_examengl2_df3d1b9a9c8539d09537_20210816094942_archive.zip';
    const ARCHIVE_SIZE       = '35183532';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'df3d1b9-16094942';
    const SECONDARY_PACKAGE_HASH = '80ae25f-16094942';
