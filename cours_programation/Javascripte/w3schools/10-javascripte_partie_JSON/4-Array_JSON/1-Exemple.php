     ...
     <script>
        function starDOc(){
           var obj = {
               ...
               "age": 28,
               "ciy": "Moronie",
               "voiture":["Lambo","Ferarie","BMW"]
           };
            for(valeur in obj){    
               if(obj[valeur]== "[object Object]"){
                   document.getElementById("demo1").innerHTML += valeur+" : ";
                   for(i in valeur.voiture){
                     document.getElementById("demo1").innerHTML +=valeur.voiture[i]+"<br>";   
                   }
               }else{
