        ...
        <div class="cadre" id="cadre">
            <div id="demo">
                <form name="MonForm" action="" onsubmit="return validerForm()" method="post">
                    <input id="inp1" min="100" max="300" type="number" name="fname" >
                    <button id="inp2" onclick="validerForm()">Tester</button>
                </form>
            </div>
            <p id="alert">Si le nombre est supérieur à 100 (l'attribut max de l'entrée), un message d'erreur s'affiche.</p>
        </div>
        <script>
            'use strict';
            function validerForm(){
                var txt = ""; if(document.getElementById("inp1").validity.rangeOverflow){
                   txt = "valeur trop grand";
                }else{
                    txt = "trouver";
                }
