...
<body>
    ...
    <form method ="post" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
          nom : <input type="text" name="nom" value="<?php echo $nom; ?>"><span class="error"> *<?php echo $nomErr ?></span>
        <br><br>
      ...
      Website : <input type="text" name="website" value="<?php echo $website; ?>"><span class="error"> *<?php echo $websiteErr ?></span>  
        <br><br>
      Comment : <textarea name="comment" row="5" cols="40"><?php echo $comment; ?></textarea> <br><br>
        <input type="radio" name="genre" <?php if(isset($genre) && $genre=="Femme") echo "checked";?> value="Femme">Female 
        <input type="radio" name="genre" <?php if(isset($genre) && $genre=="Homme") echo "checked"; ?> value="Homme">Homme 
        <input type="radio" name="genre" <?php if(isset($genre) && $genre=="Autre") echo "checked"; ?> value="Autre">Autre
